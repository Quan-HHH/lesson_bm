...
//         if(idAttr && idAttr.value === selector.replace('#', ''))
//             return true;
//     } else if(selector.charAt(0) === '.') {
//         let classAttr = ele.attributes.find(e => e.name === 'class');
//         if(classAttr && classAttr.value === selector.replace('#', ''))
//             return true;
//     } else {
...
// //     // 计算符合这个ele的所有css规则 || css规则应用到这个节点上
// //     // 1. 靠ele属性父节点 和css 里面选择器匹配
// //     // 2. 匹配 从后往前匹配
// //     let elements = stack.slice(0).reverse(); //复制一份
